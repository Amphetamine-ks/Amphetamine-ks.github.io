	...
	*/
	...
	public static function formElements( $item=NULL, \IPS\Node\Model $container=NULL )
	{
		...
		if( \count( $categories ) )
		{
			...
			$return[ 'entry_category_id' ] = new \IPS\Helpers\Form\Select( 'entry_category_id', ( $item AND $item->category_id ) ? $item->category_id : ( \IPS\Request::i()->cat ? \IPS\Request::i()->cat : NULL ), FALSE, array( 'options' => $options ), NULL, NULL, NULL, "entry_category_id" );
		}
