...
\IPS\Content\EditHistory
{
	...
	public static function _findOccurances( $eventStart, $eventEnd, $startDate, $endDate, $recurringData )
	{
		...
		if( $keyword !== NULL )
		{
			...
			/* If this is a daily recurring event that occurs ever day, fast forward the start date to the beginning of our period */
	...
	public static function formElements( $item=NULL, \IPS\Node\Model $container=NULL )
	{
		...
		$return['header']		= new \IPS\Helpers\Form\Upload( 'event_cover_photo', ( $item AND $item->cover_photo ) ? \IPS\File::get( 'calendar_Events', $item->cover_photo ) : NULL, FALSE, array( 'image' => TRUE, 'allowStockPhotos' => TRUE, 'storageExtension' => 'calendar_Events' ) );
