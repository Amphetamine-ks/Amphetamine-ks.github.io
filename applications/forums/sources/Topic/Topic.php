...
{
	use \IPS\Content\Reactable, \IPS\Content\Reportable, \IPS\Content\Statistics, \IPS\Content\Solvable;
	...
	{
		return $this->container()->forums_bitoptions['bw_enable_answers_member'];
	}
