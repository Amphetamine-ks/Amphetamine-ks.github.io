...
class _Forum extends \IPS\Node\Model implements \IPS\Node\Permissions
{
	...
	{
        if( !$this->memberCanAccessOthersTopics( \IPS\Member::loggedIn() ) )
        {
            try
            {
	...
	public function form( &$form )
	{
		...
		$form->add( new \IPS\Helpers\Form\Upload( 'forum_card_image', $this->card_image ? \IPS\File::get( 'forums_Cards', $this->card_image ) : NULL, FALSE, array( 'image' => TRUE, 'storageExtension' => 'forums_Cards', 'allowStockPhotos' => TRUE ), NULL, NULL, NULL, 'forum_card_image' ) );
