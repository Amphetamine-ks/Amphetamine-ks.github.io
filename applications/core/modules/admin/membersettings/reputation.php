...
class _reputation extends \IPS\Node\Controller
{
	...
	protected function manage()
	{
		...
		else if ( $activeTab === 'leaderboard' )
		{
			...
			$form->add( new \IPS\Helpers\Form\Select( 'leaderboard_excluded_groups', explode( ',', \IPS\Settings::i()->leaderboard_excluded_groups ), FALSE, array( 'options' => \IPS\Member\Group::groups( TRUE, FALSE ), 'parse' => 'normal', 'multiple' => TRUE ), NULL, NULL, NULL, 'leaderboard_excluded_groups' ) );
