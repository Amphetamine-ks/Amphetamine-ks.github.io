...
class _mobile extends \IPS\Dispatcher\Controller
{
	...
	protected function submit()
	{
		...
		try
		{
			...
			$form->add( new \IPS\Helpers\Form\Select( 'mobile_app_listing_languages', $existing ? explode( ',', $existing['languages'] ): ['en'], TRUE, array( 'multiple' => TRUE, 'options' => $langaugeOptions ) ) );
		}
		catch ( \Exception $e )
		{
