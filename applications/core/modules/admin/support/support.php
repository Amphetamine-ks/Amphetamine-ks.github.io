...
class _support extends \IPS\Dispatcher\Controller
{
	...
	{
		return [
			'apps'		=> $this->_thirdPartyApps( TRUE ),
			'plugins'	=> $this->_thirdPartyPlugins( TRUE ),
			'theme'		=> $this->_thirdPartyTheme(),
			'editor'	=> $this->_thirdPartyEditor(),
			'ads'		=> $this->_thirdPartyAds()
		];
	}
