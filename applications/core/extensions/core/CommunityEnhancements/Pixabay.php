...
class _Pixabay
{
	...
	public function edit()
	{
		...
		$form->add( new \IPS\Helpers\Form\Select( 'pixabay_editor_permissions', \IPS\Settings::i()->pixabay_editor_permissions == '*' ? '*' : explode( ',', \IPS\Settings::i()->pixabay_editor_permissions ), NULL, array( 'multiple' => TRUE, 'options' => $groups, 'unlimited' => '*', 'unlimitedLang' => 'everyone' ), NULL, NULL, NULL, 'pixabay_editor_permissions_access' ) );
