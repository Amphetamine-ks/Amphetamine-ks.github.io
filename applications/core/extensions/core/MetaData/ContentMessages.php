...
class _ContentMessages
{
	 ...
	 * @return	int
	 */
	public function addMessage( $message, $color = NULL, \IPS\Content\Item $item, \IPS\Member $member = NULL, bool $isPublic = TRUE )
	{
		$member = $member ?: \IPS\Member::loggedIn();
	 ...
	 * @return	void
	 */
	public function editMessage( $id, $message, $color = NULL, \IPS\Content\Item $item, \IPS\Member $member = NULL, bool $isPublic = TRUE )
	{
		$member = $member ?: \IPS\Member::loggedIn();
