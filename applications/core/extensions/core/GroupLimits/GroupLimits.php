...
class _GroupLimits
{
	...
	public function getLimits()
	{
		return array(
			...
			'zeroIsBest'	=> array( 'g_displayname_unit', 'g_sig_unit', 'g_mod_preview', 'g_ppd_limit', 'g_ppd_unit', 'gbw_no_status_update', 'g_max_bgimg_upload', 'gbw_disable_prefixes', 'gbw_disable_tagging', 'g_hide_online_list' ),
			'callback'		=> array(
