...
class _Db extends \mysqli
{
	...
	/* @deprecated */
	const SELECT_SQL_CALC_FOUND_ROWS = 2;	// This is deprecated and will throw an exception if you attempt to use it
	...
	public function select( $columns=NULL, $table, $where=NULL, $order=NULL, $limit=NULL, $group=NULL, $having=NULL, $flags=0 )
	{
		...
		if ( $flags & static::SELECT_SQL_CALC_FOUND_ROWS AND \IPS\IN_DEV )
		{
			throw new \IPS\Db\Exception( "Constant SELECT_SQL_CALC_FOUND_ROWS is no longer supported", -2 );
		}
