...
class _Feature extends \IPS\Patterns\ActiveRecord implements \JsonSerializable
{
	 ...
	 * @return	void
	 */
	public static function form( &$form, \IPS\Application $application, ?\IPS\Application\Feature $current, ?int $version ): void
	{
	 ...
	 * @return	void
	 */
	public static function markRead( ?\IPS\Member $member, \IPS\Application\Feature ...$features ): void
	{
		...
		if ( \count( $insert ) )
		{
			\IPS\Db::i()->insert( 'core_members_feature_seen', $insert );
		}
	}
	 ...
	 * @return	void
	 */
	public static function writeJsonFile( string $appKey, int $versionId ): void
	{
