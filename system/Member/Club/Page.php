...
class _Page extends \IPS\Patterns\ActiveRecord
{
	 ...
	 * @return	void
	 */
	public function set_club( \IPS\Member\Club $club ): void
	{
	 ...
	 * @return	void
	 */
	public static function form( \IPS\Helpers\Form $form, \IPS\Member\Club $club, ?\IPS\Member\Club\Page $current = NULL ): void
	{
